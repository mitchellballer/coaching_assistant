...
class DetailedAthlete(object):
    ...
    def __init__(self, id=None, resource_state=None, firstname=None, lastname=None, profile_medium=None, profile=None, city=None, state=None, country=None, sex=None, premium=None, summit=None, created_at=None, updated_at=None, follower_count=None, friend_count=None, measurement_preference=None, ftp=None, weight=None, clubs=None, bikes=None, shoes=None):  # noqa: E501

...
class Route(object):
    ...
    def __init__(self, athlete=None, description=None, distance=None, elevation_gain=None, id=None, map=None, name=None, private=None, starred=None, timestamp=None, type=None, sub_type=None, segments=None):  # noqa: E501
